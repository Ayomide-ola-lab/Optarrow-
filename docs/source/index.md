...
:align: center
:width: 20%
<span style="font-style: normal; font-weight: bold; font-size: 1.5em;">OptArrow</span><br>
...
* **Multi-backend support** 
   Users can run the same model through solvers like HiGHS, Gurobi, Mosek, or GLPK — simply by switching a backend configuration.
...
* 📘 [How to Define an LP Problem](tutorials/lp_problem)
* 📘 [How to Use OptArrow to solve an LP Problem](tutorials/lp_example1)
